...
**Toponaming Next Steps**. **@JohnAD**, Ondsel Developer and team lead for the TNP mitigation project worked with various developers to work out what the next phase of that project looks like, and published the next set of steps we need to undertake. Things get exciting right about now, as we [actually begin using the system to track element history](https://github.com/FreeCAD/FreeCAD/issues/8432#issuecomment-1676433915). Help wanted! If you are interested in learning what this TNP thing is all about, and want to assist in the project, [drop me a line](mailto:chennes@freecad.org) and I'll get you an invite to the group Telegram chat.
